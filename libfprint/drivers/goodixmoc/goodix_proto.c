...
{ 0x0,  0x4c11db7,  0x9823b6e,  0xd4326d9,  0x130476dc, 0x17c56b6b, 0x1a864db2, 0x1e475005, 0x2608edb8,
  ...
  0x44190b0d, 0x40d816ba, 0xaca5c697, 0xa864db20, 0xa527fdf9, 0xa1e6e04e, 0xbfa1b04b,
  0xbb60adfc, 0xb6238b25, 0xb2e29692, 0x8aad2b2f, 0x8e6c3698, 0x832f1041, 0x87ee0df6,
  0x99a95df3, 0x9d684044, 0x902b669d, 0x94ea7b2a, 0xe0b41de7, 0xe4750050, 0xe9362689,
  0xedf73b3e, 0xf3b06b3b, 0xf771768c, 0xfa325055, 0xfef34de2, 0xc6bcf05f, 0xc27dede8,
  0xcf3ecb31, 0xcbffd686, 0xd5b88683, 0xd1799b34, 0xdc3abded, 0xd8fba05a, 0x690ce0ee,
  0x6dcdfd59, 0x608edb80, 0x644fc637, 0x7a089632, 0x7ec98b85, 0x738aad5c, 0x774bb0eb,
  0x4f040d56, 0x4bc510e1, 0x46863638, 0x42472b8f, 0x5c007b8a, 0x58c1663d, 0x558240e4,
  0x51435d53, 0x251d3b9e, 0x21dc2629, 0x2c9f00f0, 0x285e1d47, 0x36194d42, 0x32d850f5,
  0x3f9b762c, 0x3b5a6b9b, 0x315d626,  0x7d4cb91,  0xa97ed48,  0xe56f0ff,  0x1011a0fa, 0x14d0bd4d,
  ...
  0x65c52d24, 0x119b4be9, 0x155a565e, 0x18197087, 0x1cd86d30, 0x29f3d35,  0x65e2082, 0xb1d065b,
  0xfdc1bec,  0x3793a651, 0x3352bbe6, 0x3e119d3f, 0x3ad08088, 0x2497d08d, 0x2056cd3a,
  0x2d15ebe3, 0x29d4f654, 0xc5a92679, 0xc1683bce, 0xcc2b1d17, 0xc8ea00a0, 0xd6ad50a5,
  0xd26c4d12, 0xdf2f6bcb, 0xdbee767c, 0xe3a1cbc1, 0xe760d676, 0xea23f0af, 0xeee2ed18,
  0xf0a5bd1d, 0xf464a0aa, 0xf9278673, 0xfde69bc4, 0x89b8fd09, 0x8d79e0be, 0x803ac667,
  0x84fbdbd0, 0x9abc8bd5, 0x9e7d9662, 0x933eb0bb, 0x97ffad0c, 0xafb010b1, 0xab710d06,
  ...
  pack_header *pheader)
{
  ...
  pheader->len = MAKEWORDIDX (buffer, 4) - PACKAGE_CRC_SIZE;
                        ...
                        )
{
  ...
  if (fid_buffer_size < 70)
    //g_error("FingerId buffer Length is error, buffer too small!");
    return -1;
  ...
  if (buffer[Offset++] != 67)
    //g_error("FixLength is error, should be 67, but is %d!", buffer[Offset++]);
    return -1;
...
int
gx_proto_parse_body (uint16_t cmd, uint8_t *buffer, uint32_t buffer_len, pfp_cmd_response_t presp)
{
  uint32_t offset = 0;
  ...
  switch (HIBYTE (cmd))
    ...
    case MOC_CMD0_GET_VERSION:
      memcpy (&presp->version_info, buffer + 1, sizeof (fp_version_info_t));
      break;
    ...
    case MOC_CMD0_CHECK4DUPLICATE:
      ...
      if (presp->check_duplicate_resp.duplicate)
        {
          uint16_t tid_size = MAKEWORDIDX (buffer, 1);
    ...
    case MOC_CMD0_GETFINGERLIST:
      ...
      g_debug ("total finger number: %d", presp->finger_list_resp.finger_num);
      ...
      for(uint8_t num = 0; num < presp->finger_list_resp.finger_num; num++)
        {
          uint16_t fingerid_length = MAKEWORDIDX (fingerlist, offset);
          g_debug ("finger[%d] size: %d", num, fingerid_length);
          offset += 2;
    ...
    case MOC_CMD0_IDENTIFY:
      {
        ...
        if (presp->verify.match)
          {
            offset += 1;
            presp->verify.rejectdetail = MAKEWORDIDX (buffer, offset);
            offset += 2;
            score = MAKEDWORDIDX (buffer, offset);
            offset += 4;
            study = MAKEWORDIDX (buffer, offset);
            offset += 1;
            fingerid_size = MAKEWORDIDX (buffer, offset);
            offset += 2;
...
static uint8_t sensor_config[26] = {
  0x00, 0x00, 0x64, 0x50, 0x0f, 0x41, 0x08, 0x0a, 0x0c, 0x00, 0x00, 0x23, 0x00,
  0x00, 0x01, 0x01, 0x00, 0x01, 0x01, 0x01, 0x01, 0x00, 0x01, 0x01, 0x05, 0x05
};

int
gx_proto_init_sensor_config (pfp_sensor_cfg_t pconfig)
{
