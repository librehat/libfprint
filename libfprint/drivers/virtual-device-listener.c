      ...
      if (!success)
        {
          ...
          g_warning ("Error receiving stream data: %s", error->message);
        }
...
void fp_device_virtual_listener_read (FpDeviceVirtualListener *self,
                                       void *buffer,
                                       gsize count,
...
gsize fp_device_virtual_listener_read_finish (FpDeviceVirtualListener *self,
                                                 GAsyncResult *result,
                                                 GError      **error)
{
