...
static void
verify_iterate_cmd_cb (FpiUsbTransfer* transfer,
                       FpDevice* self,
                       gpointer user_data,
                       GError* error)
{
