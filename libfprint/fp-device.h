 ...
 * @FP_DEVICE_FEATURE_DUPLICATES_CHECKS: Natively supports duplicates detection
...
typedef enum {
  ...
  FP_DEVICE_FEATURE_CAPTURE = 1 << 1,
  FP_DEVICE_FEATURE_IDENTIFY = 1 << 2,
  FP_DEVICE_FEATURE_VERIFY = 1 << 3,
  FP_DEVICE_FEATURE_DUPLICATES_CHECKS = 1 << 4,
  FP_DEVICE_FEATURE_STORAGE = 1 << 5,
  FP_DEVICE_FEATURE_STORAGE_LIST = 1 << 6,
  FP_DEVICE_FEATURE_STORAGE_DELETE = 1 << 7,
  FP_DEVICE_FEATURE_STORAGE_CLEAR = 1 << 8,
} FpDeviceFeature;
